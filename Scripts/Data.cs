...
public static class Data 
{
    ...
    //array that holds the cos & sins used for rotating
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };

    //Dictionray that holds key: Tetronino name/type and key: position of the cells that form the tetromino 
    ...
    //tests to test the new position of I tetromino when rotating
    ...
    //tests to test the new position of the rest of the tetromino when rotating
    ...
    //dictionary of the tetromino and its corresponding tests
